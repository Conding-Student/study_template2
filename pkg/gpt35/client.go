...
const ModelGpt35Turbo = "gpt-4o-mini"

// 4096
const MaxTokensGpt35Turbo = 500
...
// // WithRegion allows setting the region by modifying the base URL
// func WithRegion(region string) OptionFunc {
// 	return func(opts *ClientOptions) error {
// 		if region == "hk" {
// 			opts.URL = "https://api.openai.com/hk/v1/chat/completions" // Hypothetical regional URL
// 		} else {
